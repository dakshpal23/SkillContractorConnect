...
const LoginBilingual = ({ onNavigateToSignup, onNavigateToUserDashboard, onNavigateToContractorDashboard }) => {
    ...
    <div style={{
      ...
      <form onSubmit={handleLogin}>
        ...
        <div style={{ textAlign: 'center', marginTop: '25px' }}>
          <p style={{ color: '#636e72', marginBottom: '15px' }}>{t('dontHaveAccount')}</p>
          <button
