...
const LandingPage = ({ onNavigateToLogin, onNavigateToSignup }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: "Get your projects done right",
      image: "🏗️"
    },
    {
      title: "Join as Worker",
      subtitle: "Showcase your skills and earn",
      image: "🔧"
    }
  ];
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { icon: '🔍', title: 'Find Workers', desc: 'Search skilled professionals' },
            { icon: '✅', title: 'Verified Profiles', desc: 'All users are verified' },
            { icon: '💼', title: 'Secure Payments', desc: 'Safe and secure transactions' }
          ].map((feature, index) => (
            <div
              key={index}
              style={{
